...
class GameLevelWater {
  ...
  constructor(gameEnv) {
    ...
    // Background data
    const image_src_water = path + "/CSSE-Nico/images/gamify/deepseadungeon.jpeg";
    ...
    const sprite_src_octopus = path + "/CSSE-Nico/images/gamify/octopus.png"; // be sure to include the path
    ...
    const sprite_src_nomad = path + "/CSSE-Nico/images/gamify/animwizard.png"; // be sure to include the path
