...
class GameLevelStarWars {
  constructor(gameEnv) {
    ...
    // Background data
    const image_src_atat = path + "/CSSE-Nico/images/gamify/atat_background.png"; // be sure to include the path
    ...
    const sprite_src_snowspeeder = path + "/CSSE-Nico/images/gamify/snowspeeder_sprite2.png"; // be sure to include the path
    ...
    const sprite_src_turret = path + "/CSSE-Nico/images/gamify/turret_aa.png"; // be sure to include the path
    ...
    const sprite_src_laser = path + "/CSSE-Nico/images/gamify/laser_bolt.png"; // be sure to include the path
