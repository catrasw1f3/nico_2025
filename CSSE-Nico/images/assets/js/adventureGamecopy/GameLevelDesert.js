...
class GameLevelDesert {
  constructor(gameEnv) {
    ...
    // Background data
    const image_src_desert = path + "/CSSE-Nico/images/gamify/desert.png"; // be sure to include the path
    ...
    const sprite_src_chillguy = path + "/CSSE-Nico/images/gamify/chillguy.png"; // be sure to include the path
    ...
    // NPC data for Tux 
    const sprite_src_tux = path + "/CSSE-Nico/images/gamify/tux.png"; // be sure to include the path
    ...
    const sprite_data_tux = {
      ...
      const sprite_src_octocat = path + "/CSSE-Nico/images/gamify/octocat.png"; // be sure to include the path
    ...
    const sprite_src_robot = path + "/CSSE-Nico/images/gamify/robot.png"; // be sure to include the path
    ...
    // NPC Data for R2D2
    const sprite_src_r2d2 = path + "/CSSE-Nico/images/gamify/r2_idle.png"; // be sure to include the path
